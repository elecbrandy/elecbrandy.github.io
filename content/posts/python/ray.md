...
누구나 읽기만 가능하다.
데이터가 읽기 전용으로 변했기 때문에, 수천 개의 Actor가 동시에 달려들어 읽어도 데이터가 깨질 일이 없다. 어처피 수정하지 못한다.  

- **4. 데이터 불변성 (Immutable)** <br>
