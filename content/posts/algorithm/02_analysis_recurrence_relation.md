...
title = '알고리즘의 재귀적 분석'
date = 2024-09-30
featured_image = "https://substackcdn.com/image/fetch/$s_!1oOq!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F5edc4abf-f75a-48d1-847f-9896de85dcd7_704x354.jpeg"
tags = ['algorithm']
+++
...
이전에 공부했던 <a href="https://elecbrandy.github.io/posts/algorithm/merge_sort/"> _merge sort_ </a> 을 활용해서 재귀적 접근의 여러가지 분석 방법을 공부해보자.
...
<img src="https://i.imgur.com/jBkUXgx.png" max-width=100%>
...
**Iteration Method**는 재귀적 관계식을 반복적으로 확장하여 하나의 패턴을 찾아내는 방법이다.
...
<img src="https://i.imgur.com/aMIxeFx.png" max-width=100%>
<img src="https://i.imgur.com/h3AsjVw.png" max-width=100%>

1. **$f(n) = \Theta(n^{\log_b a})$**
   - 이 경우, 하위 문제를 나누고 해결하는 데 걸리는 시간과 병합하는 데 걸리는 시간이 동일하다.
   - 이때 전체 시간 복잡도는 **$T(n) = \Theta(n^{\log_b a} \log n)$** 가 된다. (여기서 로그 항은 병합 단계의 추가 비용 의미)
...
<img src="https://i.imgur.com/0NfOQJb.png" max-width=100%>
...
이를 Master Method에 적용하면, $a = b^d$ 이므로 **case 1**에 해당한다. 따라서 병합 정렬의 시간 복잡도는!
